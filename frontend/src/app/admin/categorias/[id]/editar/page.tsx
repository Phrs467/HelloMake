...
export default function EditarCategoria() {
  ...
  const [initialData, setInitialData] = useState<{ nome: string; descricao: string }>({
    nome: "",
    descricao: "",
  });
    ...
    <div className="max-w-4xl mx-auto py-8">
      ...
      <div className="mb-10">
        <div className="flex items-center gap-3 mb-2">
           ...
           <h1 className="text-4xl font-outfit font-black tracking-tight text-[#D81B60]">Editar Categoria</h1>
        </div>
        <p className="text-hotPink/80 text-lg ml-14">Atualize as informações desta categoria.</p>
      </div>
      ...
      <form onSubmit={handleSubmit} className="space-y-8 relative">
        ...
        {success && (
          <div className="absolute -top-4 right-0 bg-green-50 text-green-700 px-6 py-4 rounded-2xl border border-green-200 shadow-lg shadow-green-100 flex items-center gap-3 animate-in fade-in slide-in-from-top-4">
            ...
            <div>
              <p className="font-bold">Atualizado com Sucesso!</p>
              <p className="text-sm opacity-90">As informações foram salvas na base de dados.</p>
            </div>
          </div>
        )}
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-x-8 gap-y-6">
            ...
            <div className="space-y-2 col-span-1 md:col-span-2">
              ...
              <div className="relative">
                <input required name="name" defaultValue={initialData.nome} type="text" className="w-full h-14 pl-12 pr-4 bg-white rounded-2xl border-2 border-pink-100 focus:bg-pink-50/30 focus:border-vibrantPink focus:ring-4 focus:ring-pink-100/50 outline-none transition-all text-gray-800 font-bold shadow-sm shadow-pink-100/50" placeholder="Ex: Maquiagem" />
            ...
            <div className="space-y-2 col-span-1 md:col-span-2 mt-4">
              ...
              <div className="relative">
                <textarea name="description" defaultValue={initialData.descricao} rows={5} className="w-full pl-12 pr-4 py-4 bg-white rounded-3xl border-2 border-pink-100 focus:bg-pink-50/30 focus:border-vibrantPink focus:ring-4 focus:ring-pink-100/50 outline-none transition-all text-gray-800 font-bold resize-none shadow-sm shadow-pink-100/50" placeholder="Descreva os tipos de produtos que farão parte desta categoria..."></textarea>
